...
from sglang.jit_kernel.softmax import softmax_sampling, triton_softmax_sampling
...
@triton.testing.perf_report(
    triton.testing.Benchmark(
        ...
        x_vals=configs,
        line_arg="provider",
        line_vals=["jit", "triton", "flashinfer", "torch"],
        line_names=["SGL JIT Softmax", "Triton fused", "FlashInfer", "PyTorch"],
...
def benchmark(vocab_size: int, batch_size: int, provider: str):
    ...
    FN_MAP = {
        ...
        "triton": triton_softmax_sampling,
